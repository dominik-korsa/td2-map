...
fn try_parse_fork_switch(config: &HashMap<String, String>, is_right: bool) -> Option<ForkSwitch> {
    ...
    if is_right {
        (radius_left, radius_right) = (-radius_left, -radius_right);
    }
    Some(ForkSwitch {
        radius_left,
        radius_right,
...
pub(crate) static TRACK_STRUCTURES: phf::Map<&'static str, TrackStructure> = phf_map! {
    ...
    "Rld 60E1-1200_600-1_15 R" => Fork(ForkSwitch { radius_left: -600.0, radius_right: 1200.0, curve_length: 39.95566, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rld 60E1-1200_900-1_18.5 R" => Fork(ForkSwitch { radius_left: -900.0, radius_right: 1200.0, curve_length: 48.61317, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rld 60E1-1800_300-1_9 R" => Fork(ForkSwitch { radius_left: -300.0, radius_right: 1800.0, curve_length: 33.23108, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rld 60E1-1800_600-1_14 R" => Fork(ForkSwitch { radius_left: -600.0, radius_right: 1800.0, curve_length: 42.80262, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rld 60E1-1800_900-1_18.5 R" => Fork(ForkSwitch { radius_left: -900.0, radius_right: 1800.0, curve_length: 48.61317, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rld 60E1-2500_1200-1_22 R" => Fork(ForkSwitch { radius_left: -1200.0, radius_right: 2500.0, curve_length: 54.51731, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rld 60E1-2500_250-1_8.5 R" => Fork(ForkSwitch { radius_left: -250.0, radius_right: 2500.0, curve_length: 29.31069, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rld 60E1-2500_400-1_10.5 R" => Fork(ForkSwitch { radius_left: -400.0, radius_right: 2500.0, curve_length: 38.00925, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rld 60E1-2500_600-1_14 R" => Fork(ForkSwitch { radius_left: -600.0, radius_right: 2500.0, curve_length: 42.80262, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rld 60E1-2500_900-1_17 R" => Fork(ForkSwitch { radius_left: -900.0, radius_right: 2500.0, curve_length: 52.14928, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rld 60E1-600_300-1_9 R" => Fork(ForkSwitch { radius_left: -300.0, radius_right: 600.0, curve_length: 29.92537, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rld 60E1-650_450-1_15 R" => Fork(ForkSwitch { radius_left: -450.0, radius_right: 650.0, curve_length: 29.96674, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rld 60E1-700_190-1_7.5 R" => Fork(ForkSwitch { radius_left: -190.0, radius_right: 700.0, curve_length: 25.22173, tangent: 9.0, added_length: 0.0 }),
    ...
    "Rld 60E1-700_300-1_10 R" => Fork(ForkSwitch { radius_left: -300.0, radius_right: 700.0, curve_length: 29.38637, tangent: 9.0, added_length: 0.0 }),
    ...
    "Rld 60E1-700_500-1_14 R" => Fork(ForkSwitch { radius_left: -500.0, radius_right: 700.0, curve_length: 35.66885, tangent: 9.0, added_length: 0.0 }),
    ...
    "Rld 60E1-900_300-1_9 R" => Fork(ForkSwitch { radius_left: -300.0, radius_right: 900.0, curve_length: 33.23108, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rld 60E1-900_450-1_12 R" => Fork(ForkSwitch { radius_left: -450.0, radius_right: 900.0, curve_length: 37.43512, tangent: 9.0, added_length: 0.0 }),
    ...
    "Rld 60E1-900_600-1_15 R" => Fork(ForkSwitch { radius_left: -600.0, radius_right: 900.0, curve_length: 39.95566, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rlj 60E1-1200_300-1_7 R" => Fork(ForkSwitch { radius_left: -300.0, radius_right: -1200.0, curve_length: 42.64069, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rlj 60E1-1200_600-1_9 R" => Fork(ForkSwitch { radius_left: -600.0, radius_right: -1200.0, curve_length: 68.0, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rlj 60E1-1500_450-1_9 R" => Fork(ForkSwitch { radius_left: -450.0, radius_right: -1500.0, curve_length: 49.84663, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rlj 60E1-1800_300-1_7.5 R" => Fork(ForkSwitch { radius_left: -300.0, radius_right: -1800.0, curve_length: 39.0, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rlj 60E1-1800_450-1_9 R" => Fork(ForkSwitch { radius_left: -450.0, radius_right: -1800.0, curve_length: 49.84663, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rlj 60E1-1800_600-1_10 R" => Fork(ForkSwitch { radius_left: -599.48096, radius_right: -1800.0, curve_length: 59.85075, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rlj 60E1-600_300-1_6 R" => Fork(ForkSwitch { radius_left: -300.0, radius_right: -600.0, curve_length: 48.0, tangent: 9.0, added_length: 0.0 }),
    ...
    "Rlj 60E1-650_190-1_20 R" => Fork(ForkSwitch { radius_left: -190.0, radius_right: -650.0, curve_length: 32.47971, tangent: 9.0, added_length: 0.0 }),
    ...
    "Rlj 60E1-750_190-1_6 R" => Fork(ForkSwitch { radius_left: -190.0, radius_right: -750.0, curve_length: 31.44976, tangent: 9.0, added_length: 0.0 }),
    ...
    "Rlj 60E1-800_250-1_6.5 R" => Fork(ForkSwitch { radius_left: -250.0, radius_right: -800.0, curve_length: 38.23661, tangent: 9.0, added_length: 0.0 }),
    ...
    "Rlj 60E1-900_300-1_7.5 R" => Fork(ForkSwitch { radius_left: -300.0, radius_right: -900.0, curve_length: 39.82378, tangent: 9.0, added_length: 0.0 }),
    ...
    "Rlj 60E1-900_300-1_9 R" => Fork(ForkSwitch { radius_left: -300.0, radius_right: -900.0, curve_length: 49.84663, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rlj 60E1-900_450-1_7.5 R" => Fork(ForkSwitch { radius_left: -450.0, radius_right: -900.0, curve_length: 59.0, tangent: 9.0, added_length: 0.0 }),
    ...
    "Rz 60E1-1200-1_18.5 R" => Fork(ForkSwitch { radius_left: -1200.0, radius_right: 0.0, curve_length: 64.81756, tangent: 18.5, added_length: 0.0 }),
    ...
    "Rz 60E1-190-1_7.5 R" => Fork(ForkSwitch { radius_left: -190.0, radius_right: 0.0, curve_length: 25.221731, tangent: 7.5, added_length: 0.0 }),
    "Rz 60E1-190-1_9 L" => Fork(ForkSwitch { radius_left: 0.0, radius_right: 190.0, curve_length: 21.046352, tangent: 9.0, added_length: 6.0923653 }),
    ...
    "Rz 60E1-205-1_9 R" => Fork(ForkSwitch { radius_left: -205.0, radius_right: 0.0, curve_length: 22.707907, tangent: 9.0, added_length: 5.42 /* added manually */ }),
    ...
    "Rz 60E1-2500-1_26.5 R" => Fork(ForkSwitch { radius_left: -2500.0, radius_right: 0.0, curve_length: 94.30607, tangent: 26.5, added_length: 0.0 }),
    "Rz 60E1-265-1_10 L" => Fork(ForkSwitch { radius_left: 0.0, radius_right: 265.0, curve_length: 26.434078, tangent: 10.0, added_length: 4.75 /* added manually */ }),
    ...
    "Rz 60E1-300-1_9 R" => Fork(ForkSwitch { radius_left: -300.0, radius_right: 0.0, curve_length: 33.231083, tangent: 9.0, added_length: 0.0 }),
    ...
    "Rz 60E1-500-1_12 R" => Fork(ForkSwitch { radius_left: -500.0, radius_right: 0.0, curve_length: 41.59458, tangent: 12.0, added_length: 0.0 }),
    ...
    "Rz 60E1-760-1_14 R" => Fork(ForkSwitch { radius_left: -760.0, radius_right: 0.0, curve_length: 54.21665, tangent: 14.0, added_length: 0.0 }),
